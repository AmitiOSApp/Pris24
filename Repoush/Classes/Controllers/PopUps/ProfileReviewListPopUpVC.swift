//
//  ProfileReviewListPopUpVC.swift
//  Repoush
//
...
import UIKit
protocol delegateProfileReviewlist {
    func getProfileReviewlist()
}
class ProfileReviewListPopUpVC: UIViewController {
...
//   @IBOutlet var lblReviews: UILabel!
   ...
   @IBOutlet var lblName: UILabel!
    ...
    var isPersonal = true
    var delagate: delegateProfileReviewlist!
...
//        floatRatingView.type = .halfRatings
    ...
    @IBAction func actionCross(_ Sender:Any){
        ...
        if self.delagate != nil {
            self.delagate.getProfileReviewlist()
        }
        }
    }

extension ProfileReviewListPopUpVC : UITableViewDelegate,UITableViewDataSource{
...
extension ProfileReviewListPopUpVC: FloatRatingViewDelegate {
