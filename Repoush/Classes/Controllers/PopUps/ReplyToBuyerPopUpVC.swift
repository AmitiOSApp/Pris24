...
import Foundation
protocol delegateReplyToBuyer {
    func getReplyToBuyer(index:Int)
}

class ReplyToBuyerPopUpVC: UIViewController {
    @IBOutlet weak var lblReplyToBuyer : UILabel!
    @IBOutlet weak var txtView : UITextView!
    @IBOutlet weak var btnSubmit : UIButton!
    @IBOutlet weak var btnCancel : UIButton!
    var Index : Int = 0
    var delegate: delegateReplyToBuyer!
    var productId = ""
    var sellerId = ""
...
//                            }
                            ...
                            if self.delegate != nil {
                                self.delegate.getReplyToBuyer(index:self.Index)
                            }
