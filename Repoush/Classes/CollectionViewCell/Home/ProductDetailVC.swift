...
//    @IBOutlet weak var lblPickUpLocationLoc: UILabel!
    ...
    @IBOutlet weak var btnShareWidthConstrains: NSLayoutConstraint!
...
//    @IBOutlet weak var lblSubCategory: UILabel!
    ...
    @IBOutlet weak var viewShareQuestions: UIView!
   @IBOutlet weak var viewShareQuestionsHight: NSLayoutConstraint!
   ...
   // var isDealCompleted : Bool = false
    var isProfessional : Bool = true
    var arraySection = [[String:String]]()
        ...
        override func viewDidLoad() {
            ...
            locManager.requestWhenInUseAuthorization()
                   ...
                   if (CLLocationManager.authorizationStatus() == CLAuthorizationStatus.authorizedWhenInUse ||
                    ...
                    self.latitude =  String(format: "%7f", currentLocation.coordinate.latitude)    //location.coordinate.latitude
    ...
    func slideImagePicker()  {
        ...
        let recognizer = UITapGestureRecognizer(target: self, action: #selector(ProductDetailVC.didTap))
    ...
    func setUI() {
        print(appDelegate.mobileNumber)
        self.lblTitle.text = responseData.selling.capitalizingFirstLetter()
       
        if responseData.firstName.isEmpty {
            self.lblName.text = "UserName :- " + responseData.username.capitalizingFirstLetter()
        } else{
            ...
            self.tblView.reloadData()
                ...
                if (MyDefaults().language ?? "") as String ==  "en"{
                   ...
                   // self.changeLanguage(strLanguage: "en")
                    ...
                    var dictSelling = [String:String]()
                    dictSelling["propertyName"] = "WHAT ARE YOU SELLING?"
                    dictSelling["propertyValue"] = responseData.selling
                    self.arraySection.append(dictSelling)
                    
                    var dictCategory = [String:String]()
                    dictCategory["propertyName"] = "CATEGORY"
                    dictCategory["propertyValue"] = responseData.categoryName
                    self.arraySection.append(dictCategory)
                    
                    var dictSUBCATEGORY = [String:String]()
                    dictSUBCATEGORY["propertyName"] = "SUB CATEGORY"
                    dictSUBCATEGORY["propertyValue"] = responseData.subcategoryName
                    self.arraySection.append(dictSUBCATEGORY)
                    ...
                    if responseData.productcondition.isEmpty {
                        ...
                        var dictPRODUCTDETAIL = [String:String]()
                        dictPRODUCTDETAIL["propertyName"] = "PRODUCT DETAIL"
                        dictPRODUCTDETAIL["propertyValue"] = responseData.productcondition
                        self.arraySection.append(dictPRODUCTDETAIL)
                    }
                    
                    
                    for items in self.productProperty {
                        var dictProperty = [String:String]()
                        
                        dictProperty["propertyName"] = items.propertyName
                        dictProperty["propertyValue"] = items.propertyValue
                        self.arraySection.append(dictProperty)
                    ...
                    if responseData.descriptionField.isEmpty {
                        ...
                        dictAddress["propertyName"] = "PRODUCT DETAIL"
                        dictAddress["propertyValue"] = responseData.descriptionField
                        self.arraySection.append(dictAddress)
                    }
                    if responseData.address.isEmpty {
                        
                    } else {
                        if self.responseData.isBooked ==  "1" {
                            var dictAddress = [String:String]()
                            dictAddress["propertyName"] = "PICKUP LOCATION"
                            dictAddress["propertyValue"] = responseData.address
                            self.arraySection.append(dictAddress)
                            
                           
                       
                            var dictAddress4 = [String:String]()
                            dictAddress4["propertyName"] = "Mobile Number"
                            dictAddress4["propertyValue"] = responseData.userPhone
                            self.arraySection.append(dictAddress4)
                            
                            
                            var dictAddress2 = [String:String]()
                            dictAddress2["propertyName"] = "Buyer Name"
                            dictAddress2["propertyValue"] = responseData.buyerfirstname + " " + responseData.buyerfirstname
                            self.arraySection.append(dictAddress2)
                            
                            var dictAddress1 = [String:String]()
                            dictAddress1["propertyName"] = "Buyer Mobile Number"
                            dictAddress1["propertyValue"] = responseData.buyermobilenumber
                            self.arraySection.append(dictAddress1)
                            
                            
                            var dictAddress3 = [String:String]()
                            dictAddress3["propertyName"] = "Buyer Email"
                            dictAddress3["propertyValue"] = responseData.buyeremail
                            self.arraySection.append(dictAddress3)
...
//                        var dictAddress = [String:String]()
//                        dictAddress["propertyName"] = "Mobile Number"
//                        dictAddress["propertyValue"] = responseData.userPhone
//                        self.arraySection.append(dictAddress)
//                    }
                    ...
                    var dictSelling = [String:String]()
                    dictSelling["propertyName"] = "Auktion"
                    dictSelling["propertyValue"] = responseData.selling
                    self.arraySection.append(dictSelling)
                    
                    var dictCategory = [String:String]()
                    dictCategory["propertyName"] = "KATEGORI"
                    dictCategory["propertyValue"] = responseData.categoryName
                    self.arraySection.append(dictCategory)
                    
                    var dictSUBCATEGORY = [String:String]()
                    dictSUBCATEGORY["propertyName"] = "UNDERKATEGORI"
                    dictSUBCATEGORY["propertyValue"] = responseData.subcategoryName
                    self.arraySection.append(dictSUBCATEGORY)
                    ...
                    if responseData.productcondition.isEmpty {
                        ...
                        var dictPRODUCTDETAIL = [String:String]()
                        dictPRODUCTDETAIL["propertyName"] = "PRODUKTDETALJER"
                        dictPRODUCTDETAIL["propertyValue"] = responseData.productcondition
                        self.arraySection.append(dictPRODUCTDETAIL)
                    }
                    ...
                    if responseData.descriptionField.isEmpty {
                        ...
                        var dictAddress = [String:String]()
                        dictAddress["propertyName"] = "PRODUKTDETALJER"
                        dictAddress["propertyValue"] = responseData.descriptionField
                        self.arraySection.append(dictAddress)
                    }
                    ...
                    if responseData.address.isEmpty {
                        ...
                        if self.responseData.isBooked ==  "1" {
                            var dictAddress = [String:String]()
                            dictAddress["propertyName"] = "AFHENTNINGSADRESSSE"
                            dictAddress["propertyValue"] = responseData.address
                            self.arraySection.append(dictAddress)
                            
//                            var dictAddress1 = [String:String]()
//                            dictAddress1["propertyName"] = "Købers Mobil"
//                            dictAddress1["propertyValue"] = responseData.userPhone
//                            self.arraySection.append(dictAddress1)
                       
                            var dictAddress2 = [String:String]()
                            dictAddress2["propertyName"] = "Købers Navn"
                            dictAddress2["propertyValue"] = responseData.buyerfirstname + " " + responseData.buyerfirstname
                            self.arraySection.append(dictAddress2)
                            
                            var dictAddress4 = [String:String]()
                            dictAddress4["propertyName"] = "Købers Mobil"
                            dictAddress4["propertyValue"] = responseData.buyermobilenumber
                            self.arraySection.append(dictAddress4)
                            
                            
                            var dictAddress3 = [String:String]()
                            dictAddress3["propertyName"] = "Købers Email"
                            dictAddress3["propertyValue"] = responseData.buyeremail
                            self.arraySection.append(dictAddress3)
                    ...
                    var dictAddress = [String:String]()
                    dictAddress["propertyName"] = "Mobilnummer"
                    dictAddress["propertyValue"] = responseData.userPhone
                    self.arraySection.append(dictAddress)
                }
    
       if isHistory {
            self.viewShareQuestions.isHidden = false
            self.viewShareQuestionsHight.constant = 40
           // self.tbleViewHeaderHight(height: 545)
            self.btnShare.isHidden = true
            self.btnShareWidthConstrains.constant = 0
            self.viewPlaceBid.isHidden = true
            self.viewPlaceBidConstraintHight.constant = 0
            self.lblTimeLeft.isHidden = true
           
              //  self.lblTimeLeft.isHidden = true
                self.viewTimeLeft.isHidden = true
...
//            self.viewShareQuestions.isHidden = false
//            self.viewShareQuestionsHight.constant = 40
//            self.tbleViewHeaderHight(height: 520)
            self.viewTimeLeft.isHidden = false
            self.btnShare.isHidden = false
            self.btnShareWidthConstrains.constant = 82
            if LoggedInUser.shared.id ?? "" == self.responseData.userId {
                self.viewPlaceBid.isHidden = true
                self.viewPlaceBidConstraintHight.constant = 0
              // self.tbleViewHeaderHight(height: 448)
            }else{
                self.viewPlaceBid.isHidden = false
                self.viewPlaceBidConstraintHight.constant = 42
               // self.tbleViewHeaderHight(height: 800)
            }
        }
        self.tblView.reloadData()
    }
...
//            }
      ...
      //  self.tblView.tableFooterView?.frame.size = CGSize(width:tblView.frame.width, height: CGFloat(100))
        //self.tblView.contentInset = UIEdgeInsets(top: -20, left: 0, bottom: -20, right: 0);
    }
...
//        let image = UIImage(named: "Product")
        let myWebsite = NSURL(string: shareAuction  + self.responseData.id)
...
extension ProductDetailVC : UITableViewDelegate,UITableViewDataSource,getPlaceBid,delegateReviewProductDetail,getUserAppear,gestuserLogin {
...
//        appdelegate.window!.rootViewController = navigationController
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let dict = self.arraySection[indexPath.row]
        
        cell.lblPropertyName.text = dict["propertyName"]?.uppercased()
        cell.lblPropertyValue.text = dict["propertyValue"]?.capitalizingFirstLetter()
            return cell
        }
