//
//  ModelHistorySellerProfile.swift
//  Repoush
//
...
class ModelHistorySellerProfile : NSObject, NSCoding{

    var message : String!
    var responseCode : Int!
    var responseData : [ModelHistorySellerResponseDatum]!
    ...
    init(fromDictionary dictionary: [String:Any]){
        ...
        responseData = [ModelHistorySellerResponseDatum]()
        if let responseDataArray = dictionary["responseData"] as? [[String:Any]]{
            for dic in responseDataArray{
                let value = ModelHistorySellerResponseDatum(fromDictionary: dic)
    ...
    @objc required init(coder aDecoder: NSCoder)
    {
        ...
        responseData = aDecoder.decodeObject(forKey: "responseData") as? [ModelHistorySellerResponseDatum]
    }
...
class ModelHistorySellerResponseDatum : NSObject, NSCoding{
    ...
    var productImage : [ModelHistorSellerProductImage]!
    ...
    init(fromDictionary dictionary: [String:Any]){
        ...
        lastBid = dictionary["last_bid"] as? String
        ...
        productImage = [ModelHistorSellerProductImage]()
        if let productImageArray = dictionary["product_image"] as? [[String:Any]]{
            for dic in productImageArray{
                let value = ModelHistorSellerProductImage(fromDictionary: dic)
    ...
    @objc required init(coder aDecoder: NSCoder)
    {
        ...
        productImage = aDecoder.decodeObject(forKey: "product_image") as? [ModelHistorSellerProductImage]
...
class ModelHistorSellerProductImage : NSObject, NSCoding{
