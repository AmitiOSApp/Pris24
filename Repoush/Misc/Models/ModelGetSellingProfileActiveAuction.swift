//
//  ModelGetSellingProfileActiveAuction.swift
//  Repoush
//
//  Created by mac  on 19/09/20.
//  Copyright © 2020 Ravi Sendhav. All rights reserved.
//

import Foundation

class ModelGetSellingProfileActiveAuction : NSObject, NSCoding{

    var message : String!
    var responseCode : Int!
    var responseData : [ModelActiveAuctionResponseDatum]!
    ...
    init(fromDictionary dictionary: [String:Any]){
        ...
        responseData = [ModelActiveAuctionResponseDatum]()
        if let responseDataArray = dictionary["responseData"] as? [[String:Any]]{
            for dic in responseDataArray{
                let value = ModelActiveAuctionResponseDatum(fromDictionary: dic)
    ...
    @objc required init(coder aDecoder: NSCoder)
    {
        ...
        responseData = aDecoder.decodeObject(forKey: "responseData") as? [ModelActiveAuctionResponseDatum]
    }
...
class ModelActiveAuctionResponseDatum : NSObject, NSCoding{
    ...
    var productImage : [ModelActiveAuctionProductImage]!
    ...
    init(fromDictionary dictionary: [String:Any]){
        ...
        productImage = [ModelActiveAuctionProductImage]()
        if let productImageArray = dictionary["product_image"] as? [[String:Any]]{
            for dic in productImageArray{
                let value = ModelActiveAuctionProductImage(fromDictionary: dic)
    ...
    @objc required init(coder aDecoder: NSCoder)
    {
        ...
        productImage = aDecoder.decodeObject(forKey: "product_image") as? [ModelActiveAuctionProductImage]
...
class ModelActiveAuctionProductImage : NSObject, NSCoding{
