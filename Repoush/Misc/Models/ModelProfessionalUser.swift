...
class ModelProfessionalUser : NSObject, NSCoding{

    var message : String!
    var responseCode : Int!
    var responseData : ModelResponseProfessionalDatum!
    ...
    init(fromDictionary dictionary: [String:Any]){
        ...
        if let responseDataData = dictionary["responseData"] as? [String:Any]{
            responseData = ModelResponseProfessionalDatum(fromDictionary: responseDataData)
        }
    }
    ...
    @objc required init(coder aDecoder: NSCoder)
    {
        ...
        responseData = aDecoder.decodeObject(forKey: "responseData") as? ModelResponseProfessionalDatum
    }
...
class ModelResponseProfessionalDatum : NSObject, NSCoding{
    ...
    init(fromDictionary dictionary: [String:Any]){
        ...
        ratingList = [ModelRatingProfessionalList]()
        if let ratingListArray = dictionary["rating_list"] as? [[String:Any]]{
            for dic in ratingListArray{
                let value = ModelRatingProfessionalList(fromDictionary: dic)
    ...
    @objc required init(coder aDecoder: NSCoder)
    {
        ...
        ratingList = aDecoder.decodeObject(forKey: "rating_list") as? [ModelRatingProfessionalList]
...
class ModelRatingProfessionalList : NSObject, NSCoding{
