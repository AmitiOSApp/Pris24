...
import Foundation
class ModeProductBidDetail : NSObject, NSCoding{

    var lastBidAmount : Int!
    var message : String!
    ...
    init(fromDictionary dictionary: [String:Any]){
        lastBidAmount = dictionary["last_bid_amount"] as? Int
    ...
    {
        lastBidAmount = aDecoder.decodeObject(forKey: "last_bid_amount") as? Int
