...
import Foundation
class ModelinProgressBuyer : NSObject, NSCoding{

    var message : String!
    var responseCode : Int!
    var responseData : [ModelinProgressBuyerResponseDatum]!
    ...
    init(fromDictionary dictionary: [String:Any]){
        ...
        responseData = [ModelinProgressBuyerResponseDatum]()
        if let responseDataArray = dictionary["responseData"] as? [[String:Any]]{
            for dic in responseDataArray{
                let value = ModelinProgressBuyerResponseDatum(fromDictionary: dic)
    ...
    @objc required init(coder aDecoder: NSCoder)
    {
        ...
        responseData = aDecoder.decodeObject(forKey: "responseData") as? [ModelinProgressBuyerResponseDatum]
    }
...
class ModelinProgressBuyerResponseDatum : NSObject, NSCoding{
    ...
    var productImage : [ModelinProgressBuyerProductImage]!
    ...
    init(fromDictionary dictionary: [String:Any]){
        ...
        productImage = [ModelinProgressBuyerProductImage]()
        if let productImageArray = dictionary["product_image"] as? [[String:Any]]{
            for dic in productImageArray{
                let value = ModelinProgressBuyerProductImage(fromDictionary: dic)
    ...
    @objc required init(coder aDecoder: NSCoder)
    {
        ...
        productImage = aDecoder.decodeObject(forKey: "product_image") as? [ModelinProgressBuyerProductImage]
...
class ModelinProgressBuyerProductImage : NSObject, NSCoding{
