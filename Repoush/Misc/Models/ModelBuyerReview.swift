...
class ModelBuyerReview : NSObject, NSCoding{

    var message : String!
    var responseCode : Int!
    var responseData : ModelBuyerReviewResponseDatum!
    ...
    init(fromDictionary dictionary: [String:Any]){
        ...
        if let responseDataData = dictionary["responseData"] as? [String:Any]{
            responseData = ModelBuyerReviewResponseDatum(fromDictionary: responseDataData)
        }
    }
    ...
    @objc required init(coder aDecoder: NSCoder)
    {
        ...
        responseData = aDecoder.decodeObject(forKey: "responseData") as? ModelBuyerReviewResponseDatum
    }
...
class ModelBuyerReviewResponseDatum : NSObject, NSCoding{
    ...
    @objc required init(coder aDecoder: NSCoder)
    {
        ...
        ratingList = aDecoder.decodeObject(forKey: "rating_list") as? [ModelBuyerReviewRatingList]
        ...
        showStatus = aDecoder.decodeObject(forKey: "show_status") as? Int
...
class ModelBuyerReviewRatingList : NSObject, NSCoding{
