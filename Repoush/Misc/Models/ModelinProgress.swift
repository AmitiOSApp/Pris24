...
class ModelinProgress : NSObject, NSCoding{

    var message : String!
    var responseCode : Int!
    var responseData : [ModelInProgressSellerResponseDatum]!
    ...
    init(fromDictionary dictionary: [String:Any]){
        ...
        responseData = [ModelInProgressSellerResponseDatum]()
        if let responseDataArray = dictionary["responseData"] as? [[String:Any]]{
            for dic in responseDataArray{
                let value = ModelInProgressSellerResponseDatum(fromDictionary: dic)
    ...
    @objc required init(coder aDecoder: NSCoder)
    {
        ...
        responseData = aDecoder.decodeObject(forKey: "responseData") as? [ModelInProgressSellerResponseDatum]
    }
...
class ModelInProgressSellerResponseDatum : NSObject, NSCoding{
    ...
    var productImage : [ModelInProgressSellerProductImage]!
    ...
    init(fromDictionary dictionary: [String:Any]){
        ...
        productImage = [ModelInProgressSellerProductImage]()
        if let productImageArray = dictionary["product_image"] as? [[String:Any]]{
            for dic in productImageArray{
                let value = ModelInProgressSellerProductImage(fromDictionary: dic)
    ...
    @objc required init(coder aDecoder: NSCoder)
    {
        ...
        lastBid = aDecoder.decodeObject(forKey: "last_bid") as? Int
        ...
        orderDatetime = aDecoder.decodeObject(forKey: "order_datetime") as? String
        ...
        productImage = aDecoder.decodeObject(forKey: "product_image") as? [ModelInProgressSellerProductImage]
    ...
    @objc func encode(with aCoder: NSCoder)
    {
        ...
        if orderDatetime != nil{
            aCoder.encode(orderDatetime, forKey: "order_datetime")
        }
        if orderId != nil{
...
class ModelInProgressSellerProductImage : NSObject, NSCoding{
