...
class ModelBuyerActiveAuction : NSObject, NSCoding{

    var message : String!
    var responseCode : Int!
    var responseData : [ModelBuyerActiveAuctionResponseDatum]!
    ...
    init(fromDictionary dictionary: [String:Any]){
        ...
        responseData = [ModelBuyerActiveAuctionResponseDatum]()
        if let responseDataArray = dictionary["responseData"] as? [[String:Any]]{
            for dic in responseDataArray{
                let value = ModelBuyerActiveAuctionResponseDatum(fromDictionary: dic)
    ...
    @objc required init(coder aDecoder: NSCoder)
    {
        ...
        responseData = aDecoder.decodeObject(forKey: "responseData") as? [ModelBuyerActiveAuctionResponseDatum]
    }
...
class ModelBuyerActiveAuctionResponseDatum : NSObject, NSCoding{
    ...
    var productImage : [ModelBuyerAuctionProductImage]!
    var productName : String!
    var productProperty : String!
    var rating : String!
    var ratingList : [ModelInprogressBuyerRatingList]!
    var review : Int!
    var role : String!
    var sellerId : String!
    ...
    init(fromDictionary dictionary: [String:Any]){
        ...
        bidId = dictionary["id"] as? String
        productImage = [ModelBuyerAuctionProductImage]()
        if let productImageArray = dictionary["product_image"] as? [[String:Any]]{
            for dic in productImageArray{
                let value = ModelBuyerAuctionProductImage(fromDictionary: dic)
                productImage.append(value)
            }
        }
        ratingList = [ModelInprogressBuyerRatingList]()
        if let ratingListArray = dictionary["rating_list"] as? [[String:Any]]{
            for dic in ratingListArray{
                let value = ModelInprogressBuyerRatingList(fromDictionary: dic)
    ...
    @objc required init(coder aDecoder: NSCoder)
    {
        ...
        productImage = aDecoder.decodeObject(forKey: "product_image") as? [ModelBuyerAuctionProductImage]
        ...
        ratingList = aDecoder.decodeObject(forKey: "rating_list") as? [ModelInprogressBuyerRatingList]
        ...
        bidId = aDecoder.decodeObject(forKey: "id") as? String
    }
    ...
    @objc func encode(with aCoder: NSCoder)
    {
        ...
        if bidId != nil{
            aCoder.encode(bidId, forKey: "id")
        }
    }
}
class ModelInprogressBuyerRatingList : NSObject, NSCoding{
...
class ModelBuyerAuctionProductImage : NSObject, NSCoding{
