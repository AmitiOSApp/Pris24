//
//  ModelHistoryBuyerProfile.swift
//  Repoush
//
...
class ModelHistoryBuyerProfile : NSObject, NSCoding{

    var message : String!
    var responseCode : Int!
    var responseData : [ModelHistoryBuyerResponseDatum]!
    ...
    init(fromDictionary dictionary: [String:Any]){
        ...
        responseData = [ModelHistoryBuyerResponseDatum]()
        if let responseDataArray = dictionary["responseData"] as? [[String:Any]]{
            for dic in responseDataArray{
                let value = ModelHistoryBuyerResponseDatum(fromDictionary: dic)
    ...
    @objc required init(coder aDecoder: NSCoder)
    {
        ...
        responseData = aDecoder.decodeObject(forKey: "responseData") as? [ModelHistoryBuyerResponseDatum]
    }
...
class ModelHistoryBuyerResponseDatum : NSObject, NSCoding{
    ...
    var productImage : [ModelBuyerProductImage]!
    var productName : String!
    var productProperty : String!
    var rating : String!
    var ratingList : [ModelBuyerRatingList]!
    var review : Int!
    var role : String!
    var sellerId : String!
    ...
    @objc required init(coder aDecoder: NSCoder)
    {
        ...
        productImage = aDecoder.decodeObject(forKey: "product_image") as? [ModelBuyerProductImage]
        ...
        ratingList = aDecoder.decodeObject(forKey: "rating_list") as? [ModelBuyerRatingList]
...
class ModelBuyerRatingList : NSObject, NSCoding{
...
class ModelBuyerProductImage : NSObject, NSCoding{
