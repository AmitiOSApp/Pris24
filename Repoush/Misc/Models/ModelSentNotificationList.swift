//
//  ModelSentNotificationList.swift
//  Repoush
//
...
class ModelSentNotificationList : NSObject, NSCoding{

    var message : String!
    var offerList : [ModelOfferList]!
    ...
    @objc required init(coder aDecoder: NSCoder)
    {
        ...
        offerList = aDecoder.decodeObject(forKey: "offer_list") as? [ModelOfferList]
...
class ModelOfferList : NSObject, NSCoding{
