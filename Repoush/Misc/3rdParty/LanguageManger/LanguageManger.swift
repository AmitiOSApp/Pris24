...
class LanguageManger {
    ...
    func setLanguage(language: Languages) {
        ...
        let semanticContentAttribute:UISemanticContentAttribute = language == .fa ? .forceRightToLeft : .forceLeftToRight
...
enum Languages: String {
    case ar,en,nl,ja,ko,vi,ru,sv,fr,es,pt,it,de,da,fi,nb,tr,el,id,ms,th,hi,hu,pl,cs,sk,uk,hr,ca,ro,he, fa
    case enGB = "en-GB"
    case enAU = "en-AU"
    case enCA = "en-CA"
    case enIN = "en-IN"
